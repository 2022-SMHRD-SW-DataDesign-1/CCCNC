...
<body>
	...
	<div class="logo">
		...
		<div class="in_tap">
			<h4><a href="Mypage.jsp" style="color: black;">내정보 <a></h4>
		
		
			<h4><a href="Mycharge.jsp" style="color: black;"> My충전소 </a></h4>
	...
	<div class="content">
		<div id="in_content">
			...
			<div id="content_msg">
				...
				<span id="clickLatlng" style="display:none;"></span>
				<div id="info">
					<legend>My충전소</legend>
					<br>
					<div class="myphoto">
					...
					<div class="info_num">
						...
						%>
						<h4> 사업자등록번호 :  <%=info.getMember_num()%> </h4>
					</div>
					<li>
						<div class="btns">
					...
					<script>
						...
						function seoul() {
							var moveLatLon = new kakao.maps.LatLng(37.56638,
									126.977902);
							map.panTo(moveLatLon);
						}
						function busan() {
							var moveLatLon = new kakao.maps.LatLng(35.179572,
									129.075577);
							map.panTo(moveLatLon);
						}
						function daegu() {
							var moveLatLon = new kakao.maps.LatLng(35.841269,
									128.60173400000002);
							map.panTo(moveLatLon);
						}
						function incheon() {
							var moveLatLon = new kakao.maps.LatLng(37.455791,
									126.705401);
							map.panTo(moveLatLon);
						}
						function gwangju() {
							var moveLatLon = new kakao.maps.LatLng(35.160015,
									126.851329);
							map.panTo(moveLatLon);
						}
						function daejeon() {
							var moveLatLon = new kakao.maps.LatLng(36.349637,
									127.383316);
							map.panTo(moveLatLon);
						}
						function ulsan() {
							var moveLatLon = new kakao.maps.LatLng(35.538756,
									129.311327);
							map.panTo(moveLatLon);
						}
						function sejong() {
							var moveLatLon = new kakao.maps.LatLng(36.480862,
									127.29075700000001);
							map.panTo(moveLatLon);
						}
						function gyeonggi() {
							var moveLatLon = new kakao.maps.LatLng(37.263201,
									127.028574);
							map.panTo(moveLatLon);
						}
					</script>
