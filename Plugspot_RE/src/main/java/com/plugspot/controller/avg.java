...
import com.plugspot.model.avgDAO;
import com.plugspot.model.avgDTO;
...
public class avg extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<avgDTO> avg = new avgDAO().avg();
		
		
		avgDTO dto = new avgDTO(loc_seq, one_week_charge, two_week_charge, tree_week_charge, four_week_charge, five_week_charge, six_week_charge, seven_week_charge, eight_week_charge, nine_week_charge, ten_week_charge, eleven_week_charge, twelve_week_charge, charger);
		
		
		
		session.setAttribute("avg", avg);
		
		System.out.println("먼데 진짜 씨빨련아");
