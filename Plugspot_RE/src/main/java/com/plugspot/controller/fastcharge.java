...
import com.plugspot.model.fastDAO;
import com.plugspot.model.fastDTO;


public class fastcharge extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		fastDTO dto = new fastDTO(loc_seq, one_week_charge, two_week_charge, tree_week_charge, four_week_charge, five_week_charge, six_week_charge, seven_week_charge, eight_week_charge, nine_week_charge, ten_week_charge, eleven_week_charge, twelve_week_charge, charger);
		ArrayList<fastDTO> fast = new fastDAO().fast();
		
		session.setAttribute("fast", fast);
